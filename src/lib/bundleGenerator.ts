...
export function generateBundleMarkdown(data: BundleData): string {
    ...
    // Header
    sections.push(`# 📦 AI Development Context Bundle
...
> ⚠️ Items di atas TIDAK termasuk dalam MVP.
...
`)
    ...
    if (data.flowchart && data.flowchart.nodes.length > 0) {
        ...
        sections.push(`## 📊 System Architecture / Flowchart
...
`)
    ...
    // AI Instructions
    sections.push(`## 🤖 Notes for AI Assistant
